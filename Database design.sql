...
INSERT INTO DNBC_Posts(PostTitle,PostSummary,PostWriter,PostDateTime,CategoryID,PostContent) values
	...
	('p2','Pardew rubbishes ADO Den Haag bonus payment claims','ADO Den Haag manager Alan Pardew has denied reports stating he will receive a bonus for avoiding relegation after the Dutch season was terminated this week because of the COVID-19 pandemic.','Reuters','2020-04-26','The decision to scrap the season meant ADO Den Haag, who were second from bottom in the table, seven points from the safety zone, will survive, having looked like going down.One British newspaper reported former West Ham United, Newcastle United, Southampton and Crystal Palace boss Pardew would receive a 100,000 pounds ($123,670) bonus payment.In a statement on the clubs website, however, the 58-year-old Pardew said: "If I was formally entitled to an amount, I would never want to receive it. In this difficult period, I would always return any bonus to the club, which will certainly find a good destination for it." Pardew said he wanted the money given to Den Haags non-playing staff or donated to the Dutch health service."I hope this clears up any misunderstandings caused by press reports," he added.Pardew was appointed as manager of the Dutch minnows in December tasked with saving them from relegation. Yet with the relegation battle and the title fight being scrapped, the English coach can be said to have succeeded.Although he admitted: "Of course there is relief, but modesty is in order. I had the belief that we could accomplish our mission, we were not in good shape and we will never know if we would have succeeded. "We count our blessings and understand the frustrations at SC Cambuur and De Graafschap." SC Cambur and De Graafschap were both set to gain promotion to the top flight from the Dutch second tier. Watford strike late to pile pressure on West Brom boss Pardew',10),
	('p3','Lame duck Neville needs to launch new era of Lionesses success','Outgoing Lionesses manager Phil Neville has 15 months in which to help select his replacement. Carrie Dunn says that the last two years have ended in real disappointment - and whoever takes over needs to deliver success.','Carrie Dunn','2020-04-26','It wasnt the way anyone would have wanted or expected it, but Phil Nevilles departure from the role of England Lionesses manager has finally been confirmed.Hands were basically forced all round - his contract was initially due to expire in the summer of 2021, after the 2020 Olympic Games and after a home European Championships. The coronavirus pandemic now means that both competitions will be held a year later and so Neville will not lead his England side in another major tournament - and its possible if not probable he wont be coaching Team GB through the Olympics either, although there has been no decision on that one way or the other as yet. So for the next 15 months, England essentially have a lame duck coach. He might be dealing with the same admin as usual, and working with his staff to put together training packages for the squad during the footballing hiatus; but by the time England kick a ball in anger again it will be a matter of a handful of weeks until he leaves the job. Whatever philosophy and game plans he might have will be rendered irrelevant when a new manager takes over. Or perhaps not. The FA have been clear that part of the reason for the early announcement of his departure is so that he can be part of the selection committee for his replacement. This is a fairly decent and common principle in many HR departments; the person actually doing the job obviously has an insight into who will be best suited to fill their shoes. Except - and whisper this, for it goes against much of the perceived wisdom - Nevilles time as England boss has been something of a disappointment. With all the financial and staff support anyone could wish for, the Lionesses still only made the semi-finals of the Womens World Cup last year - finishing fourth, as opposed to the third place theyd achieved in 2015. (Cynics and those with long memories might wonder what Hope Powell - England manager from 1998 to 2013 - might have done given similar resources.) Since the summer of 2019, England have lost seven of their last 11 matches, and failed to defend their SheBelieves Cup title in March. When he took over, the Lionesses were the top-ranked side in Europe; now they are third. Of course, Neville had to hit the ground running. He stepped into a vacancy that had been left unfilled for several months after Mark Sampsons hurried and controversial departure in the autumn of 2017; it seemed that nobody wanted to coach a team who had won a World Cup bronze medal and just reached the semi-finals of the European Championship. There were four names that observers discussed repeatedly then - Laura Harvey, Emma Hayes, Nick Cushing and John Herdman - and all four ruled themselves out swiftly. Might one of them feel that this could be their time, a few years on? Harvey is now working in the US Soccer junior set-up, Cushing has just left Manchester City to take a job in MLS with New York City, and Herdman oversees all of Canadian mens international football. Hayes is the only one still in England, but she has been quick to point out how very happy she is at Chelsea. Neville was an unexpected choice in 2018, but he knew how the FA operated, and he was keen on the role - that was apparently enough. It might have to be the same for the person who follows him. Although Neville had the UEFA Pro Licence the FA deemed obligatory for anyone wanting to take on the job, he didnt have any experience in a head coachs role - and he certainly didnt have any experience in the womens game. He worked hard to get to know the players available to him and the way the game operated. He drew on the backing of his support staffs knowledge, and had the good fortune to be helped out by former captain Casey Stoney - now the Manchester United manager - for his first few months in situ.',10),
	('p4','"Just wondering": Roger Federers comments add fuel to ATP-WTA merger debate','"Just wondering ... am I the only one thinking that now is the time for mens and womens tennis to be united and come together as one?"','Peter Bodo ESPN.com Staff Writer','2020-04-23','"Just wondering ... am I the only one thinking that now is the time for mens and womens tennis to be united and come together as one?" It would be a seemingly innocuous statement had it been written by any tennis player or fan with time to contemplate the state of the sport. Its a nice idea that has been floated more times than anyone can count. But because this time the player was Roger Federer, and the comment was made through the megaphone of Twitter during uncertain times brought on by the coronavirus pandemic, the comment gained immediate traction. The result was a groundswell of support for the Swiss icons suggestion. "You are not the only one," tweeted No. 2-ranked womens player Simona Halep. "I agree [about the need to merge], and have been saying so since the early 1970s," tennis legend Billie Jean King tweeted. "One voice, women and men together, has long been my vision for tennis. The WTA on its own was always Plan B."Rafael Nadal was among the uniformly supportive male players and tennis commentators who chimed in: "Hey @rogerfederer as you know per our discussions I completely agree that it would be great to get out of this world crisis with the union of mens and womens tennis in one only organisation." Clearly, the social distancing that the pandemic has required, along with the shutdown of economic activity, has led people to step back and take a deep breath, viewing their respective professions with fresh eyes. "When things are going very well, no one wants to give up anything in any business. You cant get anyone to focus on change," Chris Kermode, executive chairman and president of the ATP from 2014 to 2019, told ESPN.com. "You tend to get people focusing on different ideas and potential changes when theres a crisis. So necessity drives a lot of these decisions." The crisis is evident: Professional tennis came to a standstill on the eve of the Indian Wells combined event, and no ATP or WTA tournaments will be played until at least July 13, the week after Wimbledon would have ended, had it not been canceled. The economic impact of the lockdown has been profound, especially for players ranked outside the top 200.Administrators for both the ATP and WTA were developing a new interest in bridging the divide between the tours in recent months, even before the economic crisis brought on by the coronavirus pandemic. At the Australian Open in January, WTA president Micky Lawler met with Andrea Gaudenzi, Kermodes successor, as well as Tennis Australia officials, to discuss ways to create a closer working relationship between the tours. The top item on the agenda: creating a womens companion event to the season-opening ATP Cup, with as many points of commonality as possible.',11),
	('p5','A big ask for Murray to win a Grand Slam - Rusedski','The extended lockdown of tennis will help Andy Murrays return from injury but it will be "a big ask" for him to add to his three Grand Slam titles, according to former British number one Greg Rusedski.','Reuters','2020-04-27','The extended lockdown of tennis will help Andy Murrays return from injury but it will be "a big ask" for him to add to his three Grand Slam titles, according to former British number one Greg Rusedski. Murray underwent hip re-surfacing surgery at the start of 2019 and resumed playing doubles in June before returning to singles action in August. He did not compete at the U.S. Open but won the title in Antwerp in October -- his first on the ATP Tour for two years. Murray, 32, has not played a competitive match this year because of bone bruising near the site of his surgery. With tennis unlikely to return until at least late July because of the coronavirus pandemic, the Scot has plenty of time to get himself 100% fit for when play resumes. Yet Rusedski says it will be tough for twice Wimbledon champion Murray to regain his former place in the so-called big four of mens tennis alongside Roger Federer, Rafa Nadal and Novak Djokovic. "The good news for him is that hes had more of a rest at this point," Rusedski told Sky Sports on Sunday. "Hopefully his body comes back, but to challenge week in week out with Nadal, Federer, Djokovic, [Stefanos] Tsitsipas is going to be hard. "Can he win matches? Can he possibly win a Tour event? Yes, he can do so. But to win Slams, thats three out of five sets, seven matches, thats a little bit difficult. Its possible he can get to a quarterfinal, fourth round, but to go all the way with the surgeries hes had, thats a big ask. "But I hope he proves me wrong, like hes done on several occasions." Former world number one Murray is now ranked at 129. Next week he will swap his racked for a controller as he plays in the virtual Madrid Open, featuring 32 of the worlds best players including Nadal and Dominic Thiem.',11),
...
INSERT INTO DNBC_Collections(CollectionID,Link) values ('y1','imgs/PostID_01.webp'),('y2','imgs/PostID_02.webp'),('y3','imgs/PostID_03.webp'),('y4','imgs/PostID_04.webp'),('y5','imgs/PostID_05.webp'), 
	...
	('20','imgs/PostID_p01.jpg'),('p2','imgs/PostID_p02.jpg'),('p3','imgs/PostID_p03.jpg'),('p4','imgs/PostID_p04.jpg'),('p5','imgs/PostID_p05.jpg'),('p6','imgs/PostID_p06.jpg');
