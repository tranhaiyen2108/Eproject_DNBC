...
<div class="section">
    <div class="container">
        <div class="ArticlePage_container col-xs-9">
            <div class="ArticleHeader_container">
                <div class="ArticleHeader_container_top">
                    <h1 class="ArticleHeader_headline">Billionaire investor Howard Marks calls the oil crash ‘completely rational’</h1>
                </div>
                <div class="ArticleHeader_container_bottom">
                    <div class="ArticleHeader_date_container">
                        <div class="ArticleHeader_date">PUBLISHED WED, APR 22 2020</div>
...
id y13 update DNBC_Posts set PostContent = '<div class="section">
    <div class="container">
        <div class="ArticlePage_container col-xs-9">
            <div class="ArticleHeader_container">
                <div class="ArticleHeader_container_top">
                    <h1 class="ArticleHeader_headline">OPEC and allies finalize record oil production cut after days of discussion</h1>
                </div>
                <div class="ArticleHeader_container_bottom">
                    <div class="ArticleHeader_date_container">
                        <div class="ArticleHeader_date">LISHED SUN, APR 12 2020, 2:08 PM</div>
                        <div class="Attribution_container"><div class="Attribution_attribution"><span class="Attribution_content">Reporting by
Pippa Stevens</span></div></div>
                    </div>
                </div>
            </div>
            <div class="ArticleBody_container">
...
</div>' where PostID like 'y13';

id y14 update DNBC_Posts set PostContent = '<div class="section">
    <div class="container">
        <div class="ArticlePage_container col-xs-9">
            <div class="ArticleHeader_container">
                <div class="ArticleHeader_container_top">
                    <h1 class="ArticleHeader_headline">America’s “clean energy’ workforce projected to fall by 15% in months ahead</h1>
                </div>
                <div class="ArticleHeader_container_bottom">
                    <div class="ArticleHeader_date_container">
                        <div class="ArticleHeader_date">PUBLISHED WED, APR 15 202012:06 PM</div>
                        <div class="Attribution_container"><div class="Attribution_attribution"><span class="Attribution_content">Reporting by
Anmar Frangoul</span></div></div>
                    </div>
                </div>
            </div>
            <div class="ArticleBody_container">
...
</div>' where PostID like 'y14';

id y15 update DNBC_Posts set PostContent = '<div class="section">
    <div class="container">
        <div class="ArticlePage_container col-xs-9">
            <div class="ArticleHeader_container">
                <div class="ArticleHeader_container_top">
                    <h1 class="ArticleHeader_headline">No more hamburgers? How ‘clean meat’ could transform our diets</h1>
                </div>
                <div class="ArticleHeader_container_bottom">
                    <div class="ArticleHeader_date_container">
                        <div class="ArticleHeader_date">PUBLISHED FRI, MAR 27 20205:33 AM</div>
                        <div class="Attribution_container"><div class="Attribution_attribution"><span class="Attribution_content">Reporting by
Anmar Frangoul</span></div></div>
                    </div>
                </div>
...
</div>' where PostID like 'y15';

id y16 update DNBC_Posts set PostContent = '<div class="section">
    <div class="container">
        <div class="ArticlePage_container col-xs-9">
            <div class="ArticleHeader_container">
                <div class="ArticleHeader_container_top">
                    <h1 class="ArticleHeader_headline">Some gig workers are getting $0 in unemployment benefits</h1>
                </div>
                <div class="ArticleHeader_container_bottom">
                    <div class="ArticleHeader_date_container">
                        <div class="ArticleHeader_date">PUBLISHED FRI, APR 24 20209:26 AM</div>
                        <div class="Attribution_container"><div class="Attribution_attribution"><span class="Attribution_content">Reporting by
Greg Iacurci</span></div></div>
                    </div>
                </div>
            </div>
            <div class="ArticleBody_container">
...
</div>' where PostID like 'y16';

id y17 update DNBC_Posts set PostContent = '<div class="section">
    <div class="container">
        <div class="ArticlePage_container col-xs-9">
            <div class="ArticleHeader_container">
                <div class="ArticleHeader_container_top">
                    <h1 class="ArticleHeader_headline">PMorgan tells small business customers to apply with other banks on fear that funds will run out</h1>
                </div>
                <div class="ArticleHeader_container_bottom">
                    <div class="ArticleHeader_date_container">
                        <div class="ArticleHeader_date">PUBLISHED THU, APR 23 20202:53 PM</div>
                        <div class="Attribution_container"><div class="Attribution_attribution"><span class="Attribution_content">Reporting by
Hugh Son</span></div></div>
                    </div>
                </div>
            </div>
            <div class="ArticleBody_container">
